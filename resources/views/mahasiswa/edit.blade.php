                            ...
                            <form action="{{ route('mahasiswa.update', $mhs->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="nama" value="{{ old('nama', $mhs->nama) }}">
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="email" value="{{ old('email', $mhs->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <select class="form-control select2 {{ $errors->has('prodi') ? 'is-invalid' : '' }}"
                                        ...
                                        @foreach ($prodi as $prod)
                                            <option value="{{ $prod->id }}"
                                                {{ old('prodi', $mhs->prodi_id) == $prod->id ? 'selected' : '' }}>
                                                {{ $prod->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                is-invalid
                            @enderror"
                                        name="alamat" cols="30" rows="10">{{ old('alamat', $mhs->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="no_hp" value="{{ old('no_hp', $mhs->no_hp) }}">
                                    @error('no_hp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
